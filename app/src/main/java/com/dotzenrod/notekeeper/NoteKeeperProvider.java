...
import com.dotzenrod.notekeeper.NoteKeeperProviderContract.CoursesIdColumns;
import com.dotzenrod.notekeeper.NoteKeeperProviderContract.Notes;

import java.net.URI;

import static com.dotzenrod.notekeeper.NoteKeeperDatabaseContract.*;
import static com.dotzenrod.notekeeper.NoteKeeperProviderContract.CoursesIdColumns.COLUMN_COURSE_ID;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatch) {
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.dotzenrod.notekeeper.provider.courses
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            case NOTES:
                ...
                // content://com.dotzenrod.notekeeper.provider/notes/1
