...
public class NoteReminderReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_NOTE_TITLE = "com.dotzenrod.notekeeper.extra.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.dotzenrod.notekeeper.extra.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID = "com.dotzenrod.notekeeper.extra.NOTE_ID";
